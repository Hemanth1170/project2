		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App2",
									"targetURL": "#comhemanthappsproject2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhemanthappsproject2-display": {
								"semanticObject": "comhemanthappsproject2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hemanth.apps.project2",
									"url": sap.ui.require.toUrl("com/hemanth/apps/project2")
								}
							}
						}
					}
